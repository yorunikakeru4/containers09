...
Выводы: Оптимизация контейнеров является важной частью оптимизации всего проекта, даже с учётом дешевизны памяти, на больших проектах с большим количеством зависимостей, вопрос о образах, зависимостях и оптимизации всегда стоит одним из первых
